...
<body style="font-family: ui-sans-serif, system-ui, sans-serif; line-height: 1.6; color: #1a1a1a; max-width: 32rem; margin: 0 auto; padding: 1.5rem;">
    ...
    <p style="margin: 0 0 1rem;">{{ __('Your application has been approved. You can sign in with your email address and this temporary password:') }}</p>
    ...
    <p style="margin: 0 0 1rem;">{{ __('For security, change your password after you log in (Profile → password).') }}</p>
    <p style="margin: 0 0 2rem;">
        <a href="{{ $loginUrl }}" style="display: inline-block; background-color: #c9a96e; color: #ffffff; text-decoration: none; padding: 0.65rem 1.25rem; font-weight: 600;">{{ __('Log in') }}</a>
    </p>
